...
# Form implementation generated from reading ui file 'vcf2rGFA_mac.ui'
#
...
class Ui_vcf2rGFA(object):
    def setupUi(self, vcf2rGFA):
        ...
        self.outClear.setMinimumSize(QtCore.QSize(0, 25))
        ...
        self.covert.setMinimumSize(QtCore.QSize(0, 25))
